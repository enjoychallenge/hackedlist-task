...
@pytest.mark.parametrize('base_phonebook, expected_phonebook', [
    ({'123456789': 'a'}, {'subtree': {'a': {'phone': '123456789'}},}, ),
    ({'123456789': 'a', '1': 'b'}, {'subtree': {'a': {'phone': '123456789'}, 'b': {'phone': '1'}}, },),
    ({'123456789': 'a', '1': 'b', '2345': 'ad'},
     {'subtree':
          {'a': {'phone': '123456789',
                 'subtree': {'d': {'phone': '2345'}}},
           'b': {'phone': '1'}},
      },
     ),
])
...
@pytest.mark.parametrize('base_phonebook, name, number, expected_phonebook, expected_result', [
    ({'123456789': 'a'},
     'b',
     '1',
...
@pytest.mark.parametrize('base_phonebook, name_prefix, expected_phones', [
    ({'123456789': 'a', '1': 'b', '2345': 'ad'},
     'a',
      ['123456789', '2345'],
     ),
